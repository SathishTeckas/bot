...
bot.onText(/\/start/, (msg) => {
  ...
  const message = `Hello, ${name}! Welcome to GFXvs, where creators clash for daily cash prizes. Cast your vote to secure participation NFTs and a chance to win an exclusive 1:1 masterpiece. Connect your NEAR wallet to join the thrilling competition!\nPlease click 👇 the Play button to participate in the battle.`;
